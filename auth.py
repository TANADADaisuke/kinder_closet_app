...
def verify_decode_jwt(token):
    ...
    Returns: payload provided by decoded jwt

    Note: AuthError will be raised if the token is malformed, expired,
          or compromised.
    """
    jsonurl = urlopen('https://{}/.well-known/jwks.json'.format(AUTH_DOMAIN))
